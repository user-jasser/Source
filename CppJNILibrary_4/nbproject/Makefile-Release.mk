...
${OBJECTDIR}/_ext/a8f79fa5/JavaApplication4.o: /home/napo1eon/myproject/Source/CppJNILibrary_4/JavaApplication4.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/lib/jvm/default/include -I/usr/lib/jvm/default/include/linux -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a8f79fa5/JavaApplication4.o /home/napo1eon/myproject/Source/CppJNILibrary_4/JavaApplication4.cpp

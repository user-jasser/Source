...
public class BfastBfreeBase extends ImportLayout
{
		public BfastBfreeBase(ProgramsBuilder builder, String page)
		{
				super( builder, page );
		}
		...
		public static BfastBfreeBase imports(ProgramsBuilder builder)
		{				
				return new BfastBfreeBase( builder, "com.bfast.bfree" );
		}
}
